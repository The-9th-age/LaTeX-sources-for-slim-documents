...
\newcommand{\darkprelaterule}{%
	The bearer can cast \spellformat{\evocationspellone}{\evocation} and \spellformat{\occultismspelltwo}{\occultism} as Bound Spells, Power Level (4/8), with type \castersunit{}. \spellformat{\occultismspelltwo}{} is cast as the amplified version without performing The Sacrifice.%
}
...
\newcommand{\fallennote}{\refsymbolbis{}\zerotoXunitsperarmy{6} if a \doomlord{} is General}
...
\itemrestriction{\zerotoXchoiceperarmy{2}.}%
