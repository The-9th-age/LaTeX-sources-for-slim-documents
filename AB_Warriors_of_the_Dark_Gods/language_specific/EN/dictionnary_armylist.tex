...
\newcommand{\darkprelaterule}{%
	The bearer can cast \spellformat{\evocationspellone}{\evocation} and \spellformat{\occultismspelltwo}{\occultism} as Bound Spells, Power Level (4/8), with type \castersunit{}. \spellformat{\occultismspelltwo}{} is automatically cast with the amplified version (without performing The Sacrifice).%
}
...
\newrule{At the start of} step 7 of the Pre-Game Sequence (Spell Selection), for each Ominous Gateway in your army, mark a point on the Battlefield with a Gateway Marker. This must be outside the opponent's Deployment Zone.\removedrule{ If both players have Ominous Gateways, the player that picked their Deployment Zone marks their Ominous Gateways first.}%
}
