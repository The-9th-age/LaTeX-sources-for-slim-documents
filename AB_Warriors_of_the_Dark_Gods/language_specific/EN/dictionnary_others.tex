...
Model part gains Swiftstride and reroll to-hit rolls of \result{1} when Charging. Reroll rolls of \result{1} in Charge Range rolls for units with \newrule{only} models with this Favour.%
}
...
Model gains +1 Resilience, unless it declares a \distance{10+} \newrule{(\distance{6+} for Gigantic)} Charge or \newrule{Advance/}March Moves for \distance{10+} \newrule{(\distance{6+} for Gigantic)} (lost for a Player Turn).%
}
