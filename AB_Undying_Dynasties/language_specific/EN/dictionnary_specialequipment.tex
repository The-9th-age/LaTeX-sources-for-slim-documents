...
\newcommand{\godslayerdef}{%
	The wielder gains +1 Attack Value when using this weapon. Attacks made with this weapon become \textbf{\divineattacks} and \textbf{\magicalattacks}, and gain \textbf{\multiplewounds{2}{\against{} \aegis{}}} (note that the latter also applies against models with conditional Aegis Saves).%
}
