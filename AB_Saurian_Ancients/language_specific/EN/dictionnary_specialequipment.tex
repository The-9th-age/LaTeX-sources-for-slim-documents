...
\newcommand{\suntabletdef}{%
	The bearer \newrule{always} selects its spells from all Learned Spells of its chosen Path and \spellformat{\sparkofcreation}{\hereditaryspell}. This overrides the \removedrule{normal }Spell Selection rules connected \newrule{for} Wizard Apprentice\newrule{s,} Adept\newrule{s, and Essence of a Free Mind}. This Artefact cannot be combined with Protean Potentate.%
}
