...
%%% SUB UNIT NO LOGO %%%
%%%%%%%%%%%%%%%%%	%
\newcommand{\unitnologo}[1]{%
\def\@minipagerestore{\setlength{\parskip}{\mycurrentparskip}}% Else paragraph and title spaces behave differently when inside or outside a minipage - Unit entry has spacing has been coded with this in mind, if you remove it, all spaces will be off
\defunit{#1}%
%
...
\ifsubstring{\unit@basesize}{\timess}{}{~\roundbase}\tabularnewline%
\end{tabular}%
\vspace*{-4pt}%
\end{minipage}\par%
}%
...
%%%%%%%%%%%%%%%%%%%%
%MICRO INDENT 0.3cm%%%%%%%
\newcommand{\microoptionindent}{\hspace*{0.3cm}}