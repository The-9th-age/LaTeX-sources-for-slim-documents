...
Enemy models shooting at a non-Gigantic unit with majority of models with Parting Shot \textbf{always} count as shooting at Long Range.%
}
\newcommand{\recurvebowdef}{%
Follows the rules for Bows. In addition, attacks made with a Recurve Bow gain \textbf{\quicktofire{}}. Furthermore, when shooting from Short Range, they gain +1 to hit and +1 Armour Penetration.%
}
\newcommand{\makharlancedef}{%
Follows the rules for Lances. In addition, attacks made with a Makhar Lance gain \textbf{\fightinextrarank{}} and \textbf{\twohanded}.%
}
