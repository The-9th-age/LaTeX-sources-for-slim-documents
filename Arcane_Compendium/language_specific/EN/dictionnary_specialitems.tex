...
\newcommand{\bannerofdisciplinedef}{%
	The bearer's unit may reroll failed Panic Tests. If the Battle Standard Bearer or the General is part of the bearer's unit, it automatically passes Panic Tests instead.\columnbreak%
}
...
Type: Hex, Missile, Damage. Range \distance{24}. Duration: Instant. The target suffers 2D6 hits with Strength 3, Armour Penetration 0, and \textbf{Magical Attacks}.\columnbreak%
}
