...
\newcommand{\eternalduellistdef}{%
	The Vampire \textbf{must} reroll natural to-hit and to-wound rolls of \result{1} with its Close Combat Attacks.%
}
...
\newcommand{\flyinghorrordef}{%
	The Vampire gains \textbf{\fly{7}{14}}, \textbf{\lighttroops}, \textbf{\stormofwings} (see \hyperlink{VC3batswarms}{Bat Swarms} unit), and \textbf{\swiftstride}.%
}
\newcommand{\bestialbulk}{Bestial Bulk}
\newcommand{\bestialbulkdef}{%
	The Vampire gains +1 Resilience and cannot use any Weapon Enchantments or Armour Equipment. The Vampire's Height is changed to Large and its base size to 40\timess{}\SI{40}{\milli\meter}. As long as the Vampire is joined to a unit of Ghasts, the Vampire gains \textbf{\scoring}. If playing Capture the Flags, the Vampire gains Scoring (no matter if joined to a unit of Ghasts or not).%
}
