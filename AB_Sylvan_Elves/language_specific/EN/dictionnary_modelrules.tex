...
\newcommand{\theforestfollowsdef}{%
	Right after determining who deploys first (after step 1 of the Deployment Phase Sequence), you \textbf{must} place a single \forest{} Terrain Feature:%
	\begin{itemize}%
		\item Entirely within your half of the Battlefield
		\item Not in contact with any other Terrain Feature except Open Terrain
		\item More than \distance{6} away from the centre of the board when playing Hold the Ground, and more than \distance{6} away from any marker used for the Secondary Objective.
	\end{itemize}%
