...
\newcommand{\valourdef}{%
The bearer automatically issues a Duel whenever possible (this cannot be prevented by issuing a Duel with another friendly model first), and this Duel must be accepted whenever possible. When Fighting a Duel, the bearer must reroll failed to-hit and to-wound rolls.\columnbreak%
}
