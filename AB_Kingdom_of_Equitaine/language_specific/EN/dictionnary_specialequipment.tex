...
\newcommand{\divinejudgementrestriction}{Cannot be taken by a model with Might}
...
\newcommand{\crusaderssalvationdef}{%
	The wearer gains +1 Armour and \textbf{must} reroll failed Armour Saves.%
}
\newcommand{\fortressoffaithdef}{%
	While using this Shield, the bearer \textbf{must} reroll all natural to-hit and to-wound rolls of \result{1} with its Close Combat Attacks, and \textbf{must} reroll all natural Armour Save rolls of \result{1}.%
}
...
\newcommand{\uthersconvictiondef}{%
	The bearer gains +1 Armour and \textbf{\aegis{} (+1, max. 4+, against Armour Penetration 6 or more)}.%
}
