...
\end{itemize}%
\newrule{Hunting Call is in effect even if the bearer is Ambushing and has not arrived on the Battlefield yet.}%
}

\newcommand{\primalinstinctdef}{%
At the start of each Round of Combat, each unit with one or more model parts with this Attack Attribute must take a Discipline Test. If the test is passed, all model parts with \primalinstinct{} in the unit must reroll failed to-hit rolls during this Round of Combat. 
}
...
This weapon cannot be enchanted with Weapon Enchantments from the the Common Special Equipment section.
}
