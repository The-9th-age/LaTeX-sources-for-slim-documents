...
The model's profile changes:
	\begin{itemize}
		...
		\item \newrule{It gains \textbf{\colossalstature{}}.}
...
\newcommand{\fallingstardef}{%
	...
	\newrule{The model counts as a Character for the purpose of Duels. When the model fights a Duel during a Round of Combat, it gains \textbf{Stubborn} until the end of the Round of Combat.}%
}
...
\newcommand{\acidblooddef}{%
	For each \newrule{Fortitude Save the model fails} against Melee Attacks, the model that caused the wounding hit immediately suffers \newrule{1} hit with \toxicattacks{}, before any casualties are removed, distributed onto the model's Health Pool.%
}
