...
\newcommand{\dominiondef}{%
At the start of each friendly Player Turn, you may choose one friendly unit within the Commanding Presence range of the model with Dominion. All \rnf{} models in the chosen unit are affected as described in the Dominion rule in the Character's unit entry. The effects last until the end of the next Player Turn.%
}

\newcommand{\darkfiredef}{%
\range{18}, Shots 2, \St{} 4, \AP{} 0, \textbf{\accurate{}}.\newline
Armour Save rolls of \result{1}, \result{2}, and \result{3} are \textbf{always} considered failed when saving wounds caused by \darkfire{}.%
}
