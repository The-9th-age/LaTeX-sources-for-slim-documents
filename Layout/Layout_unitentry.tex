...
{\Largerfontsize\textbf{%
	\expandafter\ifblank\expandafter{\unit@subentrynumber}{}{(\unit@subentrynumber{}) }\unit@name%
}}%
\vspace*{3pt}\newline%
...
\expandafter\ifblank\expandafter{\unit@globalnameB}{}{%
	...
	\strut\expandafter\ifblank\expandafter{\unit@globalrulesB}{}{\alphaorderlist{\unit@globalrulesB}}%
	\tabularnewline%
}%
%
\expandafter\ifblank\expandafter{\unit@globalnameC}{}{%
	...
	\strut\expandafter\ifblank\expandafter{\unit@globalrulesC}{}{\alphaorderlist{\unit@globalrulesC}}%
	\tabularnewline%
}%
\end{tabular}%
...
\expandafter\ifblank\expandafter{\unit@defensenameB}{}{%
	...
	\strut\expandafter\ifblank\expandafter{\unit@defenserulesB}{}{\alphaorderlist{\unit@defenserulesB}}%
	\expandafter\ifblank\expandafter{\unit@defensearmourB}{}{%
	\expandafter\ifblank\expandafter{\unit@defenserulesB}{}{, }%
	\alphaorderlist{\unit@defensearmourB}}%
	\tabularnewline%
}%
%
\expandafter\ifblank\expandafter{\unit@defensenameC}{}{%
	...
	\strut\expandafter\ifblank\expandafter{\unit@defenserulesC}{}{\alphaorderlist{\unit@defenserulesC}}%
	\expandafter\ifblank\expandafter{\unit@defensearmourC}{}{%
	\expandafter\ifblank\expandafter{\unit@defenserulesC}{}{, }%
	\alphaorderlist{\unit@defensearmourC}}%
	\tabularnewline%
}%
\end{tabular}%
