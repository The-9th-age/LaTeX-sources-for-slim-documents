...
\newcommand{\explicitoptions}[1]{\begin{innerframe}[\labels@options]\explicitoptionslist{#1}\end{innerframe}}
...
\newcommand{\explicitoptionstwocols}[1]{\begin{innerframetwocols}[\labels@options]%
\setlength{\columnsep}{10pt+0.3cm}%
\setlength{\multicolsep}{0pt}%
\vspace*{-3pt}\begin{multicols}{2}\explicitoptionslist{#1}\end{multicols}\end{innerframetwocols}}
...
% Magic entry.
\newcommand{\magic}[3]{\begin{innerframe}[\magicoptions]%
...
\parselist[,]{#2}{\locallists@optionschoice}%
#1%
\vspace*{-5pt}\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt]%
