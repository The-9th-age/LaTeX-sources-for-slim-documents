...
\newcommand{\printthecurrentQRSentry}{%
	...
	\expandafter\ifblank\expandafter{\rowglobalRsr}{%
		...
		\iftoggle{twocellsRsr}{%
				...
				\multicolumn{3}{@{}P{0.12\textwidth}@{}}{\hspace*{8.4pt}{\ChVal{\rowglobalRsr}}\hspace*{\fill}\strut\includegraphics[height=5pt]{logo_scoring.png}\strut\hspace*{4pt}\strut}%
		}{%
			{\ChLab{\resurrectedInitials}}&{\ChVal{\rowglobalRsr}}&%
		}%
}%
	&&%
